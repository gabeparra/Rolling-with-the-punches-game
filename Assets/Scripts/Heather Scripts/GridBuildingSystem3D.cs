...
// Stub for Mouse3D - not needed for inventory system
...
public class GridBuildingSystem3D : MonoBehaviour {
    ...
    private void HandleTypeSelect() {
        if (placedObjectTypeSOList == null) return;
        if (Input.GetKeyDown(KeyCode.Alpha1) && placedObjectTypeSOList.Count > 0) { placedObjectTypeSO = placedObjectTypeSOList[0]; RefreshSelectedObjectType(); }
        if (Input.GetKeyDown(KeyCode.Alpha2) && placedObjectTypeSOList.Count > 1) { placedObjectTypeSO = placedObjectTypeSOList[1]; RefreshSelectedObjectType(); }
        if (Input.GetKeyDown(KeyCode.Alpha3) && placedObjectTypeSOList.Count > 2) { placedObjectTypeSO = placedObjectTypeSOList[2]; RefreshSelectedObjectType(); }
        if (Input.GetKeyDown(KeyCode.Alpha4) && placedObjectTypeSOList.Count > 3) { placedObjectTypeSO = placedObjectTypeSOList[3]; RefreshSelectedObjectType(); }
        if (Input.GetKeyDown(KeyCode.Alpha5) && placedObjectTypeSOList.Count > 4) { placedObjectTypeSO = placedObjectTypeSOList[4]; RefreshSelectedObjectType(); }
        if (Input.GetKeyDown(KeyCode.Alpha6) && placedObjectTypeSOList.Count > 5) { placedObjectTypeSO = placedObjectTypeSOList[5]; RefreshSelectedObjectType(); }
